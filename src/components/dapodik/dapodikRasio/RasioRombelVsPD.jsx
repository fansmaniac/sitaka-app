...
import { 
  ...
  FileText,
  School,
  RefreshCw // FIX: Menambahkan import RefreshCw agar tidak ReferenceError
} from 'lucide-react';
          ...
          <div className="bg-white rounded-3xl w-full max-w-5xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden relative">
            ...
            <div className="flex justify-between items-center p-6 border-b border-gray-100 bg-gradient-to-r from-orange-50 to-amber-50 shrink-0">
              ...
              <div className="flex items-center gap-3">
                ...
                {aiResult && (
                  <button onClick={handleDownloadPDF} className="flex items-center gap-2 bg-orange-500 text-white text-xs font-bold px-4 py-2 rounded-xl hover:bg-orange-600 transition-colors shadow-md">
